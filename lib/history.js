...
/**
 * @class obsidian-project.lib.history
 * @constructor
 * @param {obsidian-project.lib.project-manager} pm
 * @param {Object} params
        ...
        for (var i = this._snapshots.length - 1; i >= this.$data.maxLength; --i) {
            ...
            for (var id in snapshot.blobCache) {
                ...
                if (this._blobsCount[id] <= 0) {
                    this._pm.$data.blobCache[id] = snapshot.blobCache[id];
